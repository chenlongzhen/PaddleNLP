...
def do_train():
    ...
    model = RobertaForTokenClassification.from_pretrained(args.pretrian_model_name, num_classes=num_classes)
    model = paddle.DataParallel(model)
    tokenizer = RobertaTokenizer.from_pretrained(args.pretrian_model_name)
